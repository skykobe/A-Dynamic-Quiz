...
window.onload = function() {
	...
	function ShowQues() {
		document.getElementById("1").innerHTML = AllQuestion.question[num];
		document.getElementById("2").innerHTML = AllQuestion.choice[num][0];
		document.getElementById("3").innerHTML = AllQuestion.choice[num][1];
		document.getElementById("4").innerHTML = AllQuestion.choice[num][2];
	}
}